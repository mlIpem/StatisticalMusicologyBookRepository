...
github-repo: mlIpem/StatisticalMusicologyBookRepository
...
```{r index1, message=FALSE, warning=FALSE, size = "small"}
...
```{r IndexChapterOverview, echo=FALSE, message=FALSE, warning=FALSE, out.width='75%'}
df <- rbind(
c("2","theory", "self-augmentation", "", "", ""),
c("3","modelling", "Bayesian", "", "", ""),
c("4","listening",  "appreciation", "listening", "questions", "structural equation modelling"),
c("5","dancer", "anticipation"," classical ballet", "relative phase", "regression"),
c("6","violinst", "parallax", "orchestra playing", "procustus distance", "regression"),
c("7","exoskeletons", "modalities", "dyad violin playing", "relative phase", "regression"),
c("8 & 9","tappers", "entrainment", "dyad finger tapping", "phase flow", "state-space modelling")#,
#c("10","drummers", "co-regulation", "dyad drumming", "joint prediction", "Kalman filter")
) %>% data.frame()
names(df) <-   c("#","chapter", "theory", "performance", "measure", "modelling")
knitr::kable(x = df, 
             caption = paste("Overview of chapters"),
             booktabs = TRUE, label = NA) %>%
  kable_styling("striped", font_size = 10)
# \@ref(tab:IndexChapterOverview)
```
