# Theory {#chapTheory}
```{r, init_chapTheory1, include=FALSE}
...
```{r chapTheoryInteractionHypothesis, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Engine for self-augmented interaction', message=FALSE, warning=FALSE, out.width='57%'}

  knitr::include_graphics("Figures/chapTheory_InteractionHypothesis.png")

# \@ref(fig:chapTheoryInteractionHypothesis)
# 
```
