...
```{r init_chapStatMod, message=FALSE, warning=FALSE}
...
```{r chapTheoryBayesianModel1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Bayesian model', message=FALSE, warning=FALSE, out.width='100%'}

  knitr::include_graphics("Figures/chapModelling_BayesianModel.jpg")

# \@ref(fig:chapTheoryBayesianModel1)
# 
```
...
```{r chapTheoryBayesianModel2, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Bayesian model for 2 subjects', message=FALSE, warning=FALSE, out.width='100%'}

  knitr::include_graphics("Figures/chapModelling_BayesianModel_2subjects.png")

# \@ref(fig:chapTheoryBayesianModel2)
# 
```
...
```{r chapModellingHeadD1, echo=FALSE}
...
```{r chapModellingHeadD4, echo=FALSE}
D1 %>% str()
```
...
```{r chapModellingPeriods, echo = FALSE}
knitr::kable(head(DData,10) %>% dplyr::select(names, time, dtime), 
             booktabs=T, label = NA, 
             caption = paste("Periods: inter-tap and inter-tic intervals")) %>%
  kable_styling("striped", font_size = 10)
# \@ref(tab:chapModellingPeriods)
```
...
```{r chapModellingTapping1, echo=FALSE, fig.cap='Left panel, histogram of periods. Right panel, histogram of relative phases. The blue line shows the mean at -2.03[rad] according to the circular model. The ocre line shows the mean at -1.09[rad] according to the non-circular model. The red line shows the mean at -1.68[rad] according to the synchronization strength measure', fig.show="hold", message=FALSE, warning=FALSE, out.width='100%'}

knitr::include_graphics("Figures/chapModelling_Tapping1.png")

# \@ref(fig:chapModellingTapping1)
```
...
```{r chapModellingRa, eval=FALSE, include=FALSE}
R
alpha
```
...
### Circular axis {-}
```{r chapModellingRelphase1, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
Dataset <- RelPhase %>% data.frame() %>% dplyr::select(relphase, time) %>% arrange(time) %>% head() %>% round(2)
Dataset 
```
...
```{r chapModellingTapping0, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Relative phase values over time, using a circular vertical axis', out.width='75%'}

knitr::include_graphics("Figures/chapModelling_Tapping0.png")

# \@ref(fig:chapModellingTapping0)
```


```{r chapModellingBrms1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Relative phase values over time fitted, using a circular model (blue), a non-circular model (ochre)', out.width='75%'}

knitr::include_graphics("Figures/chapModelling_Brms1.png")

# \@ref(fig:chapModellingBrms1)
...
```{r chapModellingB1predicted, echo=FALSE, warning=FALSE, fig.align='center', fig.asp=.75, fig.cap='Simulated discrete taps, using the underlying process, shown for the first 100 seconds', out.width='100%'}

knitr::include_graphics("Figures/chapModelling_B1predicted.png")

# \@ref(fig:chapModellingB1predicted)
