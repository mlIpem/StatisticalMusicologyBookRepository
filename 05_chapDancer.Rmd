...
```{r init_chapDanceMusic, message=FALSE, warning=FALSE}
...
```{r chapDancerdancer1, echo=FALSE, fig.align='center', fig.cap='Arabesque figure in ASIL, the art and science lab at UGent', out.width='100%'}

knitr::include_graphics("Figures/chapDancer_Fig_2.jpg")
...
```{r chapDancerfragment1, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", out.width='100%', fig.align='center', fig.cap='Fragment F1'}
knitr::include_graphics("Figures/chapDancer_Fig1_IF1andF1.jpg")
# \@ref(fig:chapDancerfragment1)
```

```{r chapDancerfragment2, echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold", out.width='100%', fig.align='center', fig.cap='Fragment F2'}
knitr::include_graphics("Figures/chapDancer_Fig1_F2.jpg")
# \@ref(fig:chapDancerfragment2)
```
...
```{r chapDancerdata1, echo=FALSE}
Dat <- Data %>% mutate(phase = round(phase,2), time0 = round(time0,2)) %>%  dplyr::select(phase,time0, Fragment, Participant,Heel, Trialf)

knitr::kable(head(Dat), caption = "Dataset dancer",
               booktabs=T, label = NA ) %>%
...
```{r chapDancerunique, eval=FALSE, include=FALSE}
unique(levels(Dat$Fragment))
unique(levels(Dat$Participant))
unique(levels(Dat$Heel))
unique(levels(Dat$Trialf))
```
...
```{r chapDancerDataplot1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Plot of all relative phase of heel-down events for fragments IF1, F1 and F2, (top) on a scale from 0 to 2pi, (bottom) on a scale from -pi to +pi.', message=FALSE, warning=FALSE, out.width='49%', fig.show="hold"}

  knitr::include_graphics(c("Figures/chapDancer_Dataplot_p1.png","Figures/chapDancer_Dataplot_p2.png"))

# \@ref(fig:chapDancerDataplot1)
```
...
```{r chapDancerDataplot2, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Plot of heel-down events of three different dancers for fragment F1, (top) one single trial, (bottom) all trials', message=FALSE, warning=FALSE, out.width='49%', fig.show="hold"}

  knitr::include_graphics(c("Figures/chapDancer_Dataplot_p3.png","Figures/chapDancer_Dataplot_p4.png"))

# \@ref(fig:chapDancerDataplot2)
```
...
```{r chapDancerModel1, eval=FALSE, include=TRUE}
...
```{r chapDancerModel1PPcheck, echo=FALSE, fig.cap='Posterior predictive check', message=FALSE, warning=FALSE, out.width='49%'}
  knitr::include_graphics("Figures/chapDancer_model1_pp_check.png")
# \@ref(fig:chapDancerModel1PPcheck)
```
...
```{r chapDancermodel1Fragments, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Mean and variance of heel conditions in fragments. Circular (left) versus non-circular (right) statistics on posterior', out.width='49%',fig.show="hold"}

  knitr::include_graphics(c("Figures/chapDancer_model1_Fragments.png",
                            "Figures/chapDancer_model1_Fragments2.png"))

# \@ref(fig:chapDancermodel1Fragments)
```
...
```{r chapDancermodel1FragmentsParticipants, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Showing mean and variance for each dancer among fragments', warning=FALSE, out.width='100%'}

  knitr::include_graphics("Figures/chapDancer_model1_FragmentsParticipants_new.png")

# \@ref(fig:chapDancermodel1FragmentsParticipants)
```
...
```{r chapDancerContrastFragmentsFigureA, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Contrasts (see text for explanation)', warning=FALSE, out.width='100%'}

  knitr::include_graphics("Figures/chapDancer_ContrastFragments_test_1.png")

# \@ref(fig:chapDancerContrastFragmentsFigureA)
```
...
```{r chapDancerTableContrasts1, echo=FALSE}
  Regions_labels <- readRDS(file = "Data/chapDancer_model1_Regions_labels.rds")
  Regions_numbers <- readRDS(file = "Data/chapDancer_model1_Regions_numbers.rds")
  Contrasts <- cbind(Regions_labels,Regions_numbers) %>%
    dplyr::select(fragment,est1,est2,estdiff,`pd>0`)
  knitr::kable(Contrasts, caption = "Contrasts among fragments for the heel-down condition",
               booktabs=T, label = NA ) %>%
  kable_styling("striped", font_size = 10)
  # \@ref(tab:chapDancerTableContrasts1)
```
...
```{r chapDancerModelSpecification, eval=FALSE, warning=FALSE, include=FALSE}
Dat <- Data %>% mutate(HeelFragment = factor(interaction(Heel, Fragment)) )
head(Dat)
```
...
```{r chapDancerModel2, eval=FALSE, include=TRUE}
...
```{r chapDancermodel3FragmentsParticipants, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Showing floating mean and variance for each dancer among fragments', warning=FALSE, out.width='100%'}

  knitr::include_graphics("Figures/chapDancer_model3_FragmentsParticipants.png")

# \@ref(fig:chapDancermodel3FragmentsParticipants)
```
...
```{r chapDancerContrastFigure1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Contrast of two segments', message=FALSE, warning=FALSE, out.width='100%'}
  knitr::include_graphics("Figures/chapDancer_Plots_3.png")
# \@ref(fig:chapDancerContrastFigure1)
```
...
```{r chapDancerTableContrasts2, echo=FALSE}
  Regions_labels <- readRDS(file = "Data/chapDancer_Regions_labels_segments.rds")
  Regions_numbers <- readRDS(file = "Data/chapDancer_Regions_numbers_segments.rds")
  Contrasts <- cbind(Regions_labels,Regions_numbers) %>% dplyr::select(fragment,contrast, est1,est2,estdiff,`pd>0`)
  knitr::kable(Contrasts, caption = "Contrasts among time segments for the heel-down condition",
               booktabs=T, label = NA ) %>%
  kable_styling("striped", font_size = 10)
  # \@ref(tab:chapDancerTableContrasts2)
```
