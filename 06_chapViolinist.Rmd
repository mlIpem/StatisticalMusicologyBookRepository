...
```{r chapViolinistinit1, message=FALSE, warning=FALSE, message = FALSE}
...
```{r chapViolinistTeacherAvatar1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='View on the teacher-avatar in 2D and in 3D: (a) student violinist equipped with Hololens and motion tracking suit, (b) stick figure extracted, teacher-avatar in 2D, and (c, d) teacher-avatar in 2D and 3D, as seen through the Hololens', message=FALSE, warning=FALSE, out.width='100%'}


knitr::include_graphics("Figures/chapViolinist_TeacherAvatar.jpg")

# \@ref(fig:chapViolinistTeacherAvatar1)
```
...
```{r chapViolinistDesign1, echo=FALSE, warning=FALSE}
#load(file = "Data/chapViolinist_Data.RData")
D <- Data %>% dplyr::select(subject, condition, piece) %>% arrange(piece,condition) %>% unique()
rownames(D) <- NULL
knitr::kable(D, caption = "Experimental design",
               booktabs=T, label = NA ) %>%
  kable_styling("striped", font_size = 10)
# \@ref(tab:chapViolinistDesign1)
```
...
```{r chapViolinistDesign2, echo=FALSE, message=FALSE, warning=FALSE}
D <- NewData %>%
  filter(piece == "F1", subject == "P001",trial == "T1") %>%
  dplyr::select(PD,logPD,startIndex,endIndex,time,subject,trial,condition,piece) %>% 
  mutate(PD=round(PD,2), logPD= round(logPD,2), startIndex = round(startIndex,2), 
         endIndex = round(endIndex,2),time = round(time,2))  %>% head()
knitr::kable(D, caption = "Data with procustus distance (PD)",
               booktabs=T, label = NA ) %>%
  kable_styling("striped", font_size = 10)
# \@ref(tab:chapViolinistDesign2)
```
...
```{r chapViolinistPDhist, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Density of PD for 2D and 3D', message=FALSE, warning=FALSE, out.width='49%',fig.show="hold"}

knitr::include_graphics(c("Figures/chapViolinist_PD_NewData_p1_hist.png",
                           "Figures/chapViolinist_PD_NewData_p2_hist.png"))
# \@ref(fig:chapViolinistPDhist)
```
...
```{r chapViolinistPDdata, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Data of four pieces in two conditions', message=FALSE, warning=FALSE, out.width='100%'}
 knitr::include_graphics("Figures/chapViolinist_PD_NewData_p3_data.png")
# \@ref(fig:chapViolinistPDdata)
```
...
```{r chapViolinistF1score, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Score excerpt of the first piece (F1), with time indication in seconds.', message=FALSE, warning=FALSE, out.width='100%'}

 knitr::include_graphics("Figures/chapViolinist_Score_F1.jpg")

# \@ref(fig:chapViolinistF1score)
```
...
```{r chapViolinistregrModel1, eval=FALSE, include=TRUE}
...
```{r chapViolinistPDdiff1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Piece F1 with audio (top panel), logPD and posterior predictions for 2D and 3D conditions (middle panel), and posterior difference of 2D and 3D (bottom panel). Vertical lines show the regions of interest.', message=FALSE, warning=FALSE, out.width='100%'}
  knitr::include_graphics("Figures/chapViolinist_Diff_model_F1.png")

# \@ref(fig:chapViolinistPDdiff1)
```
...
```{r chapViolinistcontrastcode1, eval=FALSE, include=TRUE}
...
```{r chapViolinistContrastblock1a, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Contrast of block1 [3.6,26]s', message=FALSE, warning=FALSE, out.width='49%'}

knitr::include_graphics("Figures/chapViolinist_ContrastBlock_1.png")

# \@ref(fig:chapViolinistContrastblock1a)
```

```{r chapViolinistContrastblock1b, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Contrast of block 2 [53,77]s', message=FALSE, warning=FALSE, out.width='49%'}

knitr::include_graphics("Figures/chapViolinist_ContrastBlock_2.png")

# \@ref(fig:chapViolinistContrastblock1b)
```
...
```{r chapViolinistBlockContrasts1, echo=FALSE}
...
names(Block_contrasts_Table) <- c("Piece[Interval]", "PDdiff", "PDdiff_min", "PDdiff_max","pd")
knitr::kable(Block_contrasts_Table, caption = "Contrasts of in defined segments of different Pieces (F1,..,F4)",
               booktabs=T, label = NA ) %>%
  kable_styling("striped", font_size = 10)
# \@ref(tab:chapViolinistBlockContrasts1)
```
...
```{r, chapViolinistIndividual1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Piece F1 with audio (top panel), logPD and posterior predictions ', message=FALSE, warning=FALSE, out.width='100%'}
  knitr::include_graphics("Figures/chapViolinist_smooths_piece_F1_condition_2D_subject_P009.png")

# \@ref(fig:chapViolinistIndividual1)
```
...
```{r GUSO2A2model2conditionspieceF1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Piece F1 with audio (top panel), logPD and posterior predictions (middle panel), and posterior difference of 2D and 3D. Vertical lines show the regions of interest', message=FALSE, warning=FALSE, out.width='100%'}
  knitr::include_graphics("Figures/chapViolinist_GUSO2_A2model_2conditions_piece_F1.rds.png")

# \@ref(fig:GUSO2A2model2conditionspieceF1)
```
...
```{r GUSO2A2model2conditionspieceF2a, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Comparison of Procustus metric for piece F2', message=FALSE, warning=FALSE, out.width='100%'}
  
knitr::include_graphics("Figures/chapViolinist_Diff_model_F2.png")

# \@ref(fig:GUSO2A2model2conditionspieceF2a)
```


```{r GUSO2A2model2conditionspieceF2b, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Comparison of relative phase metric', message=FALSE, warning=FALSE, out.width='100%'}
  
  knitr::include_graphics("Figures/chapViolinist_GUSO2_A2model_2conditions_piece_F2.rds.png")

# \@ref(fig:GUSO2A2model2conditionspieceF2b)
```
