...
```{r init_chapFingTapEntrainment2, message=FALSE, warning=FALSE}
...
```{r chapTappers2RawAll1, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Overview of all raw tapping data', message=FALSE, warning=FALSE, out.width='80%', fig.show = "hold"}
knitr::include_graphics(c("Figures/chapTappers2_AllRawdata_U_d1.png",
                        "Figures/chapTappers2_AllRawdata_U_d2.png",
                        "Figures/chapTappers2_AllRawdata_C_d1.png",
                        "Figures/chapTappers2_AllRawdata_C_d2.png"))
# \@ref(fig:chapTappers2RawAll2)
```
...
```{r chapTappers2RawAllcycle, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Overview of all raw tapping data, squeezed to one cycle, in the coupled condition (C).', message=FALSE, warning=FALSE, out.width='80%', fig.show = "hold"}
   knitr::include_graphics(c("Figures/chapTappers2_AllRawdata0c_U_d1.png", 
                            "Figures/chapTappers2_AllRawdata0c_U_d2.png",
                            "Figures/chapTappers2_AllRawdata0c_C_d1.png",
                            "Figures/chapTappers2_AllRawdata0c_C_d2.png"))
                                             

# \@ref(fig:chapTappers2RawAllcycle)
```
...
```{r chapTappers2run2 , message = FALSE}
...
```{r chapTappers2run3, fig.align='center',  fig.cap='Top: relative phase. Bottom: same but with rotated phase', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold", message = FALSE}
...
```{r chapTappers2run4, message = FALSE}
...
```{r chapTappers2run5, message = FALSE}
run = FALSE
#run = TRUE
if(run){
...
```{r chapTappers2run6, echo = FALSE, fig.align='center', fig.asp=.75, fig.cap='Posterior distribution of major parameters of the state-space model', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
plot(fit)
# save as
# saveRDS(file = fitted_model[[2]], fitted_model)
# \@ref(fig:chapTappers2run6)
```
...
```{r chapTappers2run9, message = FALSE}
...
```{r chapTappers2run10, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r chapTappers2run11, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r chapTappers2data1, echo=FALSE}
dat <- Posterior %>% select(-condition, -dyad, -cycle) %>% head(n=10) 
...
```{r chapTappers3distrKD, echo=FALSE, fig.align='center', fig.cap='Histograms show the mean of the posterior distribution of the parameter, over all 380 state-space models. Left panel the coupling strength; middle panel the phase delay; right panel the fluctuation.', message=FALSE, warning=FALSE, out.width='69%', fig.show = "hold"}
  knitr::include_graphics(c("Figures/chapTappers2_distrK.png",
                            "Figures/chapTappers2_distrD.png",
                            "Figures/chapTappers2_distrObserved.png"))
# \@ref(fig:chapTappers3distrKD)
```
...
```{r chapTappers2real1cs1K, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Estimated coupling strength in the uncoupled condition (U) (top row) and coupled condition (C) (bottom row), all dyads (numbered 1, 2, ...) and cycles are shown', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
  knitr::include_graphics(c("Figures/chapTappers2_Overview_postdistr_K.png"))

# \@ref(fig:chapTappers2real1cs1K)
...
```{r chapTappers2real1cs1D, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Estimated phase delays', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
 knitr::include_graphics(c("Figures/chapTappers2_Overview_postdistr_D.png"))

# \@ref(fig:chapTappers2real1cs1D)
...
```{r chapTappers2real1cs1E, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Estimated fluctuation', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
 knitr::include_graphics(c("Figures/chapTappers2_Overview_postdistr_Observation_std.png"))

# \@ref(fig:chapTappers2real1cs1E)
...
```{r chapTappers2LF, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Leader-folllower values. Above zero means that subject 1 is leading, below zero: subject 2.', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
  knitr::include_graphics(c("Figures/chapTappers2_LeaderFollower.png"))

# \@ref(fig:chapTappers2LF)
...
```{r chapTappers2syntax1, eval=FALSE, include=TRUE}
...
```{r chapTappers2syntax2, eval=FALSE, include=TRUE}
...
```{r chapTappers2models, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Estimated parameters per condition, excluding the group effects of cycle and dyad. (Top panel) Coupling strength. (Bottom panel) Phase delays', message=FALSE, warning=FALSE, out.width='100%',fig.show = "hold"}
  knitr::include_graphics(
                          c("Figures/chapTappers2_modelK00.png",
                          "Figures/chapTappers2_modelD00.png",
                          "Figures/chapTappers2_modelObservation_std00.png"
                          ))
# \@ref(fig:chapTappers2models)
...
```{r chapTappers2modelAllmeans, echo=FALSE, message=FALSE, warning=FALSE}

 fit_K00 <- readRDS(file = "Fitted/chapTappers2_fit_K00.rds")
 fit_D00 <- readRDS(file = "Fitted/chapTappers2_fit_D00.rds")
 fit_Observation_std00 <- readRDS(file = "Fitted/chapTappers2_fit_Observation_std00.rds")

 Posterior_selected_K <- Posterior %>% 
    filter(.variable %in% c('ks1m1', 'ks2m2')) %>% droplevels() %>% 
    select(condition,dyad,cycle, .variable,.value)
pred_K <- Posterior_selected_K %>% droplevels() %>% 
  select(condition,dyad,cycle,.variable) %>% 
  add_epred_draws(fit_K00, re_formula = NA) %>% ungroup() %>%    group_by(condition,.variable) %>% median_qi(.epred )
 
Posterior_selected_D <- Posterior %>% 
    filter(.variable %in% c("ds1m1","ds2m2","ds1s2","ds2s1")) %>% droplevels() %>% 
    select(condition,dyad,cycle, .variable,.value)
pred_D <- Posterior_selected_D %>% droplevels() %>% 
  select(condition,dyad,cycle,.variable) %>% 
  add_epred_draws(fit_D00, re_formula = NA) %>% ungroup() %>%    group_by(condition,.variable) %>% median_qi(.epred )
  
Posterior_selected_Observation <- Posterior %>% 
    filter(.variable %in% c('observation_std[1]', 'observation_std[2]', 'observation_std[3]', 'observation_std[4]')) %>% droplevels() %>% 
    select(condition,dyad,cycle, .variable,.value)
pred_Observation <- Posterior_selected_Observation %>% droplevels() %>% 
  select(condition,dyad,cycle,.variable) %>% 
  add_epred_draws(fit_Observation_std00, re_formula = NA) %>% ungroup() %>%    group_by(condition,.variable) %>% median_qi(.epred )


  pred <- rbind(pred_K,pred_D,pred_Observation) 
  
   knitr::kable(pred,  booktabs=T, label = NA, 
             caption = paste("Estimated phase delay per condition")) %>%
  kable_styling("striped", font_size = 10)
   
# \@ref(tab:chapTappers2modelAllmeans)
...
```{r chapTappers2real1cs3, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Posterior predictions', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}

if(0){
model_id = "C.dyad_9.cycle_8"
fig <- do_plot_gen_obs(model_id)
fig }else{
   knitr::include_graphics("Figures/chapTappers2_C.dyad_9.cycle_8.png")
}
# \@ref(fig:chapTappers2real1cs3)
```
...
```{r chapTappers2real1cs4, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Posterior predictions', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
if(0){
model_id = "C.dyad_2.cycle_6"
fig <- do_plot_gen_obs(model_id)
fig }else{
   knitr::include_graphics("Figures/chapTappers2_C.dyad_2.cycle_6.png")
}
# \@ref(fig:chapTappers2real1cs4)
```
...
```{r chapTappers2real1cs6, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Posterior predictions', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
if(0){
model_id = "C.dyad_8.cycle_8"
fig <- do_plot_gen_obs(model_id)
fig }else{
   knitr::include_graphics("Figures/chapTappers2_C.dyad_8.cycle_8.png")
}

# \@ref(fig:chapTappers2real1cs6)
```
...
```{r chapTappers2real1cs7, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Posterior predictions', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
if(0){
model_id = "C.dyad_1.cycle_5"
fig <- do_plot_gen_obs(model_id)
fig }else{
   knitr::include_graphics("Figures/chapTappers2_C.dyad_1.cycle_5.png")
}
# \@ref(fig:chapTappers2real1cs7)
```
...
```{r chapTappers2dynEq2, echo=TRUE, fig.align='center', fig.asp=.75, fig.cap='Generated phase-functions of average dyad interaction. (Top panel) Relative phase. (Middle panel) Instantaneous frequency. (Bottom panel) instantaneous frequency difference', message=FALSE, warning=FALSE, out.width='100%'}
...
```{r chapTappers2eq, eval=FALSE, eval=FALSE, include=FALSE}
formula = bf(relphase ~ 1 + subjectcondition + s(time0c, by = subjectcondition) + (1  |  dyad:cycle), 
             kappa ~ 1 + subjectcondition + s(time0c, by = subjectcondition) + (1  |  dyad:cycle)
             family = von_mises())
```
...
```{r chapTappersSmoothRegression, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Overview of all raw tapping data, squeezed to one cycle, in the coupled condition (C).', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
  knitr::include_graphics("Figures/chapTappers2_SmoothRegression_RelPhase.png")
                        
# \@ref(fig:chapTappersSmoothRegression)
```
...
```{r chapTappersRecurrenceAnalysis, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Recurrence analysis. Only the blue lines have to be considered. They show the uncoupled (1P Uncoupled) and coupled (2P Coupled) conditions.', message=FALSE, warning=FALSE, out.width='100%', fig.show = "hold"}
  knitr::include_graphics("Figures/chapTappers2_MattiaFigure2.jpg")
                        
# \@ref(fig:chapTappersRecurrenceAnalysis)
```
